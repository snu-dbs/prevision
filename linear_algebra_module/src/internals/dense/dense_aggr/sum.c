...
/***************************************************
 *  APIs for Group By Dim Aggregation
 ***************************************************/
                                             ...
                                             uint64_t iteration)
{
    ...
    if (iteration == 0)
    {
        // Container for Sum. Currently supports only result type of 'double'.
...
{
    double result = ((double *)state[0])[0];
