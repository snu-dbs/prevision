...
function init() {
	...
	echo "Dataset Load"
	sudo docker exec -it $DOCKER_NAME sudo -u scidb bash /prevision/evaluation/scidb/guest/load-sparse-slr00125.sh
	sudo docker exec -it $DOCKER_NAME sudo -u scidb bash /prevision/evaluation/scidb/guest/load-pagerank-small.sh
